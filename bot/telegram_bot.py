...
class ChatGPTTelegramBot:
    ...
    def __init__(self, config: dict, openai: OpenAIHelper):
        ...
        self.commands = [
            ...
            BotCommand(command='image', description='Generate image from prompt (e.g. /image girl)'),
            ...
            BotCommand(command='ask', description='To ask anything you want to ask :). e.g. /ask how are u?')
        ]
        self.disallowed_message = "Sorry, you are not allowed to use this bot. You can contact me  " \
                                  "@tequila99"
    ...
    async def help(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        help_text = 'I\'m a ChatGPT bot, talk to me!' + \
                    ...
                    '\n\n' + \
                    "This bot is coded by Binh Nguyen 2k4"
    ...
    async def image(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if image_query == '':
            await context.bot.send_message(chat_id=chat_id, text='Please provide a prompt! (e.g. /image girl)')
            return
